...
--
-- Host: localhost
-- Generation Time: Apr 14, 2024 at 11:03 PM
...
(9, 'Jeb', 'G', 'jebgallarde@gmail.com', NULL, 9),
(10, 'Jeb', 'G', 'jebgallarde@gmail.com', NULL, 10),
(11, 'Jeb', 'G', 'jebg@gmail.com', NULL, 11),
...
(25, 'jeb', 'gallarde', 'jebgallarde@gmail.com', NULL, 27),
(26, 'Jim', 'Farley', 'jfarley@gmail.com', NULL, 28),
(29, 'Shantanu ', 'Narayen', 'adobe@gmail.com', NULL, 31),
(30, 'Shantanu ', 'Narayen', 'adobe@gmail.com', NULL, 32),
(31, 'Dara', 'Khosrowshahi', 'uber@email.com', NULL, 33),
(32, 'Larry', 'Culp', 'testdnuemail@gmail.com', 19, 34),
...
(59, 'My Videography Template', 'Lorem ipsum', 1000.00, 'DIGITAL VIDEOGRAPHY', NULL, 0),
...
(26, '2024-03-18', 'test6', '<p>this is where my letter will go, looking sharp</p><p><br></p><p class=\"ql-indent-1\"><strong>Hello</strong></p>', 12, 35, NULL, 0, '2024-03-18', 'thanks', 'npoulette', 11682.00, '', 1, 0, 0),
...
(30, '2024-03-24', 'title', '<p>hi</p>', 1, 40, NULL, 1, NULL, NULL, NULL, 2268.00, NULL, 0, 0, 0),
...
(38, '2024-03-25', 'test proposal 2', 'My new letter', 1, 3, NULL, 2, '2024-04-03', 'Here is my response', 'Evan M', 4025.00, 'Evan Mah', 0, 0, 0),
...
(42, '2024-03-27', 'trial', 'Hello Client!', 1, 61, NULL, 1, NULL, NULL, NULL, 4719.00, 'Evan Mah', 0, 0, 0),
(43, '2024-03-27', 'New title', '<p>Hello</p>', 1, 62, NULL, 1, NULL, NULL, NULL, 4699.00, 'Evan Mah', 0, 0, 0),
(44, '2024-03-27', 'test', '<p>hello</p>', 1, 1, NULL, 1, NULL, NULL, NULL, 2020.00, 'Evan Mah', 0, 0, 0),
(45, '2024-03-27', 'test', '<p>hello</p>', 1, 1, NULL, 1, NULL, NULL, NULL, 2020.00, 'Evan Mah', 0, 0, 0),
(46, '2024-03-27', 'vxox', '<p>hello</p>', 1, 63, NULL, 1, NULL, NULL, NULL, 1898.00, 'Ash', 0, 0, 0),
(47, '2024-03-28', 'My New Title part 2', '<p>hell othere</p>', 1, 7, NULL, 1, NULL, NULL, NULL, 719.00, 'Evan Mah', 1, 0, 0),
(49, '2024-04-02', 'New test proposal', 'Hi Client!', 1, 3, NULL, 1, NULL, NULL, NULL, 320.00, 'Evan', 0, 0, 0),
...
(57, '2024-04-04', 'Test 001', 'Hello Client!', 13, 46, NULL, 1, NULL, NULL, NULL, 6200.00, 'Mel Miranda', 1, 1, 0),
(58, '2024-04-05', 'My Proposal Title', 'My letter', 3, 69, NULL, 2, '2024-04-05', '', '', 6668.00, 'Jeb\'s Employee 2', 1, 1, 0),
(59, '2024-04-05', 'trial 2', 'Hello Jones', 13, 38, NULL, 0, '2024-04-12', 'Employee log-in approval test', 'MM', 1800.00, 'Mel Miranda', 1, 1, 0),
(62, '2024-04-05', 'trial 3', 'Hello Client!', 13, 35, NULL, 2, '2024-04-07', 'for approval', 'J', 1750.00, 'Mel Miranda', 1, 1, 1),
(63, '2024-04-04', 'Free Coffee Proposal', '<p>Hi,</p><p><br></p><p class=\"ql-indent-1\">I am <strong>writing </strong>to <em>you </em>to ask if you want to add </p><p class=\"ql-indent-1\">free coffee to every floor at nait. this will have french vanilla, spresso shots, and decaf coffee. This will include brown sugar, white sugar and splenda. </p><ol><li>thanks</li></ol><p><br></p><p><br></p><p>Thanks,</p><p>Boss</p>', 13, 1, NULL, 1, NULL, NULL, NULL, 8848.00, 'Horhi', 0, 1, 0),
(64, '2024-04-05', 'Warm Water Machine', '<p>I need a warm water machine at NAIT HP Building. It needs to be ionized. </p>', 13, 35, NULL, 2, '2024-04-05', 'Sigi no problem', 'hehe sure.', 7271.00, 'Melody Miranda', 1, 1, 0),
(65, '2024-04-07', 'Newest Proposal', '<h1>My Heading 1</h1><p>Here is my personal letter to the client.</p>', 3, 11, NULL, 1, NULL, NULL, NULL, 2500.00, 'Jeb Gallarde', 0, 0, 0),
(66, '2024-04-07', 'Newest Proposal', '<p><br></p>', 3, 11, NULL, 1, NULL, NULL, NULL, 2500.00, 'Jeb Gallarde', 0, 0, 0),
(67, '2024-04-07', 'Jeb\'s test proposal 2', '<p>Here is my letter</p>', 3, 69, NULL, 2, '2024-04-08', 'Here is my response', 'Jeb Test', 500.00, 'Jeb Gallarde', 1, 0, 0),
(71, '2024-04-08', '', '<p>My proposal</p>', 3, 70, NULL, 2, '2024-04-12', '', '', 1000.00, 'Jeb Gallarde', 0, 1, 0),
(72, '2024-04-10', 'Drugs n stuff', '<p><br></p>', 7, 2, NULL, 1, NULL, NULL, NULL, 999.00, 'Travis Simmons', 0, 0, 0),
(73, '2024-04-10', 'Ad for Tests', '<h1><strong>Lorem Ipsum</strong> yadayadayada </h1>', 7, 68, NULL, 1, NULL, NULL, NULL, 1000.00, 'Travis Simmons', 0, 1, 0),
(74, '2024-04-10', 'Ad for Throws! ', '<h1><strong>Lorem ipsum</strong>, ads and description - fjfkfljfklsjfklfhjhlajda;jlakjud</h1>', 7, 71, NULL, 1, NULL, NULL, NULL, 1000.00, 'Travis Simmons', 1, 1, 0),
...
(77, '2024-04-12', 'heloo', '<p><strong>Hello</strong></p>', 13, 20, NULL, 1, NULL, NULL, NULL, 700.00, 'Melody ', 0, 0, 0),
(79, '2024-04-12', 'test', '<p>han</p>', 13, 10, NULL, 1, NULL, NULL, NULL, 500.00, 'Melody Miranda', 0, 0, 0),
(80, '2024-04-12', 'company', '<p><strong>Hello</strong></p>', 13, 35, NULL, 2, '2024-04-13', 'This looks good.', 'DJ', 299.00, 'Melody Miranda', 1, 0, 0),
(81, '2024-04-12', 'dgsggsg', '<h1><strong>Lorem ipsum bullshit </strong></h1>', 13, 35, NULL, 2, '2024-04-14', 'This is good', 'DJ', 5197.00, 'Melody Miranda', 1, 1, 0),
(83, '2024-04-12', 'jhchdh', '<p>sggdggew432424243242423</p>', 7, 71, NULL, 1, NULL, NULL, NULL, 299.00, 'Travis Simmons', 1, 1, 0),
(84, '2024-04-18', '789', '<p><strong>hhhh</strong></p>', 7, 68, NULL, 1, NULL, NULL, NULL, 2500.00, 'Travis Simmons', 0, 1, 0),
(85, '2024-04-16', 'adwdwaad', '<h1><strong>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaah</strong></h1>', 7, 71, NULL, 2, '2024-04-13', 'good stuff', 'mr away', 1600.00, 'Travis Simmons', 1, 1, 0),
(86, '2024-04-26', 'ada', '<p>adad</p>', 7, 1, NULL, 1, NULL, NULL, NULL, 42.98, 'Travis Simmons', 1, 1, 0),
(87, '2024-04-20', 'bbfbcb', '<p>sfsfsf</p>', 7, 32, NULL, 1, NULL, NULL, NULL, 2700.00, 'Travis Simmons', 0, 0, 0),
(88, '2024-04-14', 'April 14 Proposal', '<p>Hello this is my letter</p>', 1, 28, NULL, 1, NULL, NULL, NULL, 1642.98, 'Evan Mah', 0, 1, 0),
(89, '2024-04-17', 'hgakjfhjsfhsl', '<p>fsfsfs</p>', 7, 71, NULL, 1, NULL, NULL, NULL, 1000.00, 'Travis Simmons', 1, 1, 0),
(90, '2024-04-14', 'Test Case1', '<h1>Lorem ipsum</h1><h2><strong>dolor sit amet</strong>, consectetur adipiscing elit,&nbsp;<em>sed do eiusmod</em>&nbsp;tempor incididunt ut labore et dolore magna aliqua. </h2><p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>', 13, 35, NULL, 1, NULL, NULL, NULL, 1600.50, 'Melody ', 1, 1, 0),
(91, '2024-04-18', 'Woooo', '<h1><strong>Hell yeah</strong></h1>', 7, 7, NULL, 1, NULL, NULL, NULL, 699.00, 'Travis Simmons', 0, 1, 0),
...
(19, 'TestClient', '$2y$10$asL5vYBHqCAup7ahqDfPHO9bfntevGAgFOEOEcHAxrbFAuAkDA/56', 'testdnuemail@gmail.com', 'Test', 'Client', '0', '1'),
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'auto incrementing user_id of each user, unique index', AUTO_INCREMENT=124;
COMMIT;
