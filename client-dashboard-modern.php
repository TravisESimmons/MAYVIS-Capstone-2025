...
<body>
    ...
    <div class="dashboard-hero">
        <div class="container">
            <h1 class="hero-title" data-step="1" data-intro="Welcome to your client dashboard, <?php echo $userName; ?>! Here's a quick tour.">Welcome, <?php echo $userName; ?>!</h1>
    ...
    <div class="container">
        ...
        <?php if ($hasUnopenedProposals) : ?>
            <div class="notification-alert" data-step="2" data-intro="You have a new proposal! Check it out in the My Proposals section.">
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <a href="client-proposals.php" class="modern-btn btn-primary-modern w-100" data-step="3" data-intro="This is where you can view all your proposals.">
                    <i class="fas fa-file-contract"></i>
                    My Proposals
                </a>
            </div>
            <div class="col-md-6">
                <button id="startTutorialBtn" class="modern-btn btn-light-modern w-100">
        ...
        <div class="row g-4">
            ...
            <!-- Proposal History -->
            <div class="col-lg-8" data-step="6" data-intro="Here's your proposal history, where you can track all your past proposals and their statuses." data-position="left">
                                    ...
                                    <div class="proposal-card">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div class="flex-grow-1">
                                                <h5 class="mb-2">
                                                    <a href="client-approval.php?proposal_id=<?php echo $proposal['proposal_id']; ?>" class="proposal-link">
        ...
        <!-- What's New Section -->
        <div class="row mt-5">
            <div class="col-lg-8 mx-auto" data-step="5" data-intro="Check out what's new to stay updated with the latest features and updates." data-position="right">
                <h3 class="text-center mb-4 text-white">
                    <i class="fas fa-sparkles me-2"></i>
                    What's New
                </h3>
                
                <div class="whats-new-card" data-toggle="modal" data-target="#changeLogModal">
        ...
        <div class="modal fade" id="changeLogModal" tabindex="-1" role="dialog" aria-labelledby="changeLogModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="border-radius: var(--border-radius);">
                    <div class="modal-header" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); color: white; border-radius: var(--border-radius) var(--border-radius) 0 0;">
                    ...
                    <div class="modal-body">
                        <h6 class="fw-bold text-primary mb-3">Version 1.0 (March 2024)</h6>
                        <div class="list-group list-group-flush">
                            <div class="list-group-item border-0 px-0">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                <strong>New proposal submission process:</strong> Streamlined the process of submitting proposals to improve efficiency.
                            </div>
                            <div class="list-group-item border-0 px-0">
                                <i class="fas fa-bell text-info me-2"></i>
                                <strong>Added notification system:</strong> Users now receive notifications when new proposals are available for review.
                            </div>
                            <div class="list-group-item border-0 px-0">
                                <i class="fas fa-paint-brush text-warning me-2"></i>
                                <strong>Improved user interface:</strong> Made enhancements to the user interface to enhance usability and navigation.
                            </div>
                        </div>
                    </div>
                </div>
