...
<style>
    ...
    /* Intro.js styling for better positioning */
    .introjs-tooltip {
...
<body>
    <!-- Modern Hero Section -->
    <div class="dashboard-hero" data-step="1" data-intro="Welcome to your client dashboard, <?php echo $userName; ?>! Here's a quick tour.">
        <div class="container">
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-6">
                <a href="/mayvis/client-proposals.php" class="modern-btn btn-primary-modern w-100" data-step="3" data-intro="This is where you can view all your proposals.">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4" data-step="4" data-intro="Understand how our service works to fully utilize all features.">
            ...
            <!-- Proposal History -->
            <div class="col-lg-8" data-step="5" data-intro="Here's your proposal history, where you can track all your past proposals and their statuses.">
        ...
        <!-- What's New Section -->
        <div class="row mt-5">
            <div class="col-lg-8 mx-auto" data-step="6" data-intro="Check out what's new to stay updated with the latest features and updates.">
