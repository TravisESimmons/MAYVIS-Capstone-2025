...
<div class="main-container">
    ...
    <div class="page-header">
        <div class="content">
            ...
            <p class="page-subtitle">Update user account information and settings</p>
        </div>
    </div>
    ...
    <div class="user-info">
        ...
        <div class="user-detail">
            <i class="fas fa-at"></i>
            <strong>Username:</strong> <?php echo htmlspecialchars($user_name); ?>
        </div>
        <div class="user-detail">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const containers = document.querySelectorAll('.form-container, .page-header, .user-info');
