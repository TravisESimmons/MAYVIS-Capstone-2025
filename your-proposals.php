...
if (!empty($search)) {
    $sql .= " AND (proposal_title LIKE '%$search%' OR client_id IN (SELECT client_id FROM clients WHERE client_name LIKE '%$search%'))";
}

$total_proposals_sql = "SELECT COUNT(*) AS total_proposals FROM proposals WHERE employee_id = $employee_id";
if (!empty($search)) {
    $total_proposals_sql .= " AND (proposal_title LIKE '%$search%' OR client_id IN (SELECT client_id FROM clients WHERE client_name LIKE '%$search%'))";
}
...
?>
    ...
    <div class="container">
        <div class="">
            <h2 class="my-4">Your Proposals</h2>
            <div class="mb-4">
                ...
                <a href="proposals.php" class="btn btn-secondary">All Proposals</a>
